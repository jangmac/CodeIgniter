                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="product_name"
                                               ...
                                               value=<?php echo $views->mu_product_name; ?>
                                        >
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control " id="identify"
                                               ...
                                               value=<?php echo $views->mu_identify; ?>>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control " id="produce_ym"
                                               ...
                                               value=<?php echo $views->mu_produce_ym; ?>>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control" id="gian_num"
                                               ...
                                               value=<?php echo $views->mu_gian_num; ?>>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="buy_day"
                                    ...
                                    <div class="col-lg-10">
                                        <input class="form-control " id="buy_day"
                                               ...
                                               value=<?php echo $views->mu_buy_day; ?>>
                                    </div>
                                </div>
